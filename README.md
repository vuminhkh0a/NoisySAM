...
A tight bounding box is computed from the mask and enlarge it by an expand coefficient on each side to simulate slight localization uncertainty from real-life prompt situations.
